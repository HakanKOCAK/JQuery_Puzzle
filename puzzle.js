...
$(function() {
   ...
   $("#start").click(function(){
    ...
    var allMoves = []; // stores all the moves that are executed so far    
    for(var i=0; i<9; i++)
    ...
    var isFinished= function(){
        ...
        if(count===9){
            ...
            $("#congrats").show(0).delay(500).animate({top:275},600,function(){
                $("#congrats").children().css("margin-top","60px").animate({'font-size':'70px'},500).delay(300).animate({'font-size':'48px'},300).delay(300).animate({'font-size':'70px'},300);
            });
            $("#solve").css("font-size","15px").css("left","42%").css("margin-top","30px")
                       .html("F5 to Restart").delay(900).animate({'font-size': '25px'},300).delay(300).animate({'font-size': '15px'},300);
            return true;
        }
        return false;
    };
